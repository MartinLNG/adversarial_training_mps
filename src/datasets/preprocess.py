...
def preprocess_pipeline(X_raw: np.ndarray,
    ...
    # returns range^input_dim. Would need a custom scaler for feature by feature image range.
    scaler = MinMaxScaler(_embedding_to_range(embedding=embedding), clip=True)
